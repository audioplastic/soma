classdef gtfProc < soma.omeProc
    ...
    methods
        ...
        function value = get.bmm(obj)
            ...
            %report
            gain = abs((-2*exp(4*1i*obj.cf*pi*T)*T + ...
                2*exp(-(bRad*T) + 2*1i*obj.cf*pi*T).* ...
                T.*(cos(2*obj.cf*pi*T) - ...
                sqrt(3 - 2^(3/2))*sin(2*obj.cf*pi*T))) .*...
                (-2*exp(4*1i*obj.cf*pi*T)*T +2*exp(-(bRad*T) +...
                2*1i*obj.cf*pi*T).*T.*(cos(2*obj.cf*pi*T) +...
                sqrt(3 - 2^(3/2)) *sin(2*obj.cf*pi*T))).*...
                (-2*exp(4*1i*obj.cf*pi*T)*T +2*exp(-(bRad*T) +...
                2*1i*obj.cf*pi*T).*T.*(cos(2*obj.cf*pi*T) -...
                sqrt(3 + 2^(3/2))*sin(2*obj.cf*pi*T))) .*...
                ...
                2*1i*obj.cf*pi*T).*T.*(cos(2*obj.cf*pi*T) +...
                sqrt(3 + 2^(3/2))*sin(2*obj.cf*pi*T))) ./...
                (-2 ./ exp(2*bRad*T) - 2*exp(4*1i*obj.cf*pi*T) +...
                2*(1 + exp(4*1i*obj.cf*pi*T))./exp(bRad*T)).^4);
